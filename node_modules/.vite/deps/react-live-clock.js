...
var require_Component = __commonJS({
  "node_modules/react-live-clock/lib/Component.js"(exports) {
    "use strict";
    "use client";
    ...
    var _reactMoment = require_dist();
    var _reactMoment2 = _interopRequireDefault(_reactMoment);
    var _momentTimezone = require_moment_timezone2();
    ...
    function ReactLiveClock(props) {
      var _props$blinking = props.blinking, blinking = _props$blinking === void 0 ? false : _props$blinking, className = props.className, _props$date = props.date, date = _props$date === void 0 ? null : _props$date, _props$element = props.element, element = _props$element === void 0 ? "time" : _props$element, filter = props.filter, _props$format = props.format, format2 = _props$format === void 0 ? "HH:mm" : _props$format, _props$interval = props.interval, interval = _props$interval === void 0 ? 1e3 : _props$interval, locale2 = props.locale, _props$onChange = props.onChange, onChange = _props$onChange === void 0 ? false : _props$onChange, _props$onReady = props.onReady, onReady = _props$onReady === void 0 ? false : _props$onReady, style = props.style, _props$ticking = props.ticking, ticking = _props$ticking === void 0 ? false : _props$ticking, _props$timezone = props.timezone, timezone = _props$timezone === void 0 ? null : _props$timezone;
      var _useState = (0, _react.useState)(Date.now()), _useState2 = _slicedToArray(_useState, 2), startTime = _useState2[0], setStartTime = _useState2[1];
      var _useState3 = (0, _react.useState)(date ? new Date(date).getTime() : Date.now()), _useState4 = _slicedToArray(_useState3, 2), currentTime = _useState4[0], setCurrentTime = _useState4[1];
      var _useState5 = (0, _react.useState)(format2), _useState6 = _slicedToArray(_useState5, 2), formatToUse = _useState6[0], setFormatToUse = _useState6[1];
      var _useState7 = (0, _react.useState)(props.noSsr || false), _useState8 = _slicedToArray(_useState7, 2), noSsr = _useState8[0], setNoSsr = _useState8[1];
      var colonOn = true;
        ...
        if (ticking || blinking) {
          var tick = setInterval(function() {
            ...
            if (date) {
              ...
              now2 = new Date(date).getTime() + difference;
            }
            if (blinking) {
              if (colonOn) {
                var newFormat = format2;
                if (blinking === "all") {
                  newFormat = newFormat.replaceAll(":", " ");
                } else {
                  newFormat = reverseString(format2);
...
// node_modules/react-live-clock/lib/index.js
var require_lib = __commonJS({
  "node_modules/react-live-clock/lib/index.js"(exports, module2) {
    var ReactLiveClock = require_Component().default;
    module2.exports = ReactLiveClock;
  }
});
